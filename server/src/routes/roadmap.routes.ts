...
export function makeRoadmapRouter(k: Kdb): Router {
  ...
  router.get('/roadmap', requireRead('roadmap:read'), ctrl.read);
  router.put(
    '/roadmap',
  ...
  router.get('/roadmap/history', requireRead('roadmap:read'), ctrl.history);
  router.get('/roadmap/revisions/:id', requireRead('roadmap:read'), ctrl.showRevision);
  return router;
}
